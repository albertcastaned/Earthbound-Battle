...
public class MeterRoll : MonoBehaviour {
    ...
    void Update () {
        ...
        {
            if (damage != damagePrev && damage != 0 && !rolling )
            {
                CalculateDistance(damage);
    ...
    public IEnumerator Shake(float duration, float magnitude)
    {
        ...
        while (elapsed < duration)
        {
            ...
            transform.position = new Vector3(transform.localPosition.x + x, originalPosition.y, originalPosition.z);
